Task SieveOfEratosthenes(uint n, IList<bool> isPrime)
{
...
async Task<int> FindPrimePair(uint n)
{
    // create an array of size n + 1
    var isPrime =  new bool[n + 1] ;
    var solutions = 0;
    await SieveOfEratosthenes(n, isPrime);
...
if (num != null)
{
    ...
    var n = await FindPrimePair(number);
